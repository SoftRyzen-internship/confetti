...
const CardKreatywny: React.FC<CardKreatywnyProps> = ({ card }) => {
  ...
  return (
    <li className="mx-auto flex h-[298px] w-[320px] flex-col justify-between rounded-3xl bg-white p-[23px] md:h-[319px] md:w-[596px] md:p-12">
      <h3
